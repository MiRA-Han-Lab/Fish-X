...
from semseg.engine import Predictor


def get_args():
    parser = argparse.ArgumentParser(description="Model Training & Inference")
    parser.add_argument('--config-file', type=str,
                        help='configuration file (yaml)', default='./configs/Zebrafish-mito-CV.yaml')
    ...
    parser.add_argument('--checkpoint', type=str, default='./outputs/zebrafish-mito-soma-aff-downsample/checkpoint_500000.pth.tar',
